...
@router.post("")
async def add_bookings(user_id: UserIdDep, bookings_data: BookingsAddRequest, db: DBDep):
    room: Room | None = await db.rooms.get_one_or_none(id=bookings_data.room_id)
    hotel_id: int | None = room.hotel_id
